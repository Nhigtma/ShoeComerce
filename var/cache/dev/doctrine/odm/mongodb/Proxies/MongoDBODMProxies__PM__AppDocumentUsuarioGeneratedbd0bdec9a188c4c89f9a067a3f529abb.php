...
namespace MongoDBODMProxies\__PM__\App\Document\Usuario;

class Generatedbd0bdec9a188c4c89f9a067a3f529abb extends \App\Document\Usuario implements \ProxyManager\Proxy\GhostObjectInterface
{
    /**
    ...
    private static $signaturebd0bdec9a188c4c89f9a067a3f529abb = '';
    ...
    private function callInitializer61d02($methodName, array $parameters)
    {
        ...
        $properties = [
            ...
            'rol' => & $nonReferenceableProperties->rol,
            'telefono' => & $nonReferenceableProperties->telefono,
        ];
        ...
        isset($nonReferenceableProperties->rol) && $this->rol = $nonReferenceableProperties->rol;
        isset($nonReferenceableProperties->telefono) && $this->telefono = $nonReferenceableProperties->telefono;
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        unset($instance->nombre, $instance->email, $instance->password, $instance->rol, $instance->telefono);

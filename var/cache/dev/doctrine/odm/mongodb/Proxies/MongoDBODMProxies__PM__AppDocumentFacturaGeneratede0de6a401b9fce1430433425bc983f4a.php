...
namespace MongoDBODMProxies\__PM__\App\Document\Factura;

class Generatede0de6a401b9fce1430433425bc983f4a extends \App\Document\Factura implements \ProxyManager\Proxy\GhostObjectInterface
{
    /**
    ...
    private static $signaturee0de6a401b9fce1430433425bc983f4a = '';
    ...
    private function callInitializer61d02($methodName, array $parameters)
    {
        ...
        $nonReferenceableProperties = new class() {
            public ?\App\Document\Usuario $usuario;
            public ?\Doctrine\Common\Collections\Collection $productos;
            public ?string $tipoDePago;
            public ?float $total;
            public ?\DateTime $fecha;
        };
        $properties = [
            'usuario' => & $nonReferenceableProperties->usuario,
            'productos' => & $nonReferenceableProperties->productos,
            'tipoDePago' => & $nonReferenceableProperties->tipoDePago,
            'total' => & $nonReferenceableProperties->total,
            'fecha' => & $nonReferenceableProperties->fecha,
        ];



        $result = $this->initializer24083->__invoke($this, $methodName, $parameters, $this->initializer24083, $properties);
        isset($nonReferenceableProperties->usuario) && $this->usuario = $nonReferenceableProperties->usuario;
        isset($nonReferenceableProperties->productos) && $this->productos = $nonReferenceableProperties->productos;
        isset($nonReferenceableProperties->tipoDePago) && $this->tipoDePago = $nonReferenceableProperties->tipoDePago;
        isset($nonReferenceableProperties->total) && $this->total = $nonReferenceableProperties->total;
        isset($nonReferenceableProperties->fecha) && $this->fecha = $nonReferenceableProperties->fecha;
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        unset($instance->usuario, $instance->productos, $instance->tipoDePago, $instance->total, $instance->fecha);
